...
2 - The file PK_challenge.bin contains the public key of the challenge. Same representation as for AFF_MULT_challenge.bin except there are only n-a polynomials.
...
5 - The file lib.sage contains some functions to manipulate the previous files and sign.
